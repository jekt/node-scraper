...
function parseMetas (arrayOfSelectors, object){
	for (var i=0, x=arrayOfSelectors.length; i<x; i++){
		if (arrayOfSelectors[i]) {
			arrayOfSelectors[i].each(function(j, el){
				var attr = el.attribs,
